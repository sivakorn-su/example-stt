...
- 🎯 Entry points to execute your program using `python -m <example_stt>` or `$ example_stt` with basic CLI argument parsing.
...
[![codecov](https://codecov.io/gh/sivakorn-su/example-stt/branch/main/graph/badge.svg?token=example-stt_token_here)](https://codecov.io/gh/sivakorn-su/example-stt)
[![CI](https://github.com/sivakorn-su/example-stt/actions/workflows/main.yml/badge.svg)](https://github.com/sivakorn-su/example-stt/actions/workflows/main.yml)

Awesome example_stt created by sivakorn-su

## Install

from source
```bash
git clone https://github.com/sivakorn-su/example-stt example_stt
cd example_stt
make install
```
...
```bash
pip install example_stt
```

## Executing

```bash
$ example_stt run --port 8080
```

or

```bash
python -m example_stt run --port 8080
```

or

```bash
$ uvicorn example_stt:app
```
...
```bash
❯ example_stt --help
Usage: example_stt [OPTIONS] COMMAND [ARGS]...
...
```bash
❯ example_stt create-user --help
Usage: example_stt create-user [OPTIONS] USERNAME PASSWORD
...
```bash
example_stt create-user admin admin --superuser
```
...
Run with `example_stt run` and access http://127.0.0.1:8000/docs

![](https://raw.githubusercontent.com/rochacbruno/fastapi-project-template/master/docs/api.png)


**For some api calls you must authenticate** using the user created with `example_stt create-user`.
...
-----------------------------------------------------
example_stt/__init__.py              4      0   100%
example_stt/app.py                  16      1    94%
example_stt/cli.py                  21      0   100%
example_stt/config.py                5      0   100%
example_stt/db.py                   10      0   100%
example_stt/models/__init__.py       0      0   100%
example_stt/models/content.py       47      1    98%
example_stt/routes/__init__.py      11      0   100%
example_stt/routes/content.py       52     25    52%
example_stt/routes/security.py      15      1    93%
example_stt/routes/user.py          52     26    50%
example_stt/security.py            103     12    88%
-----------------------------------------------------
TOTAL                               336     66    80%
...
> `dynaconf_merge` is a boolean that tells if the settings should be merged with the default settings defined in example_stt/default.toml.
