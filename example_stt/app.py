...
description = """
example_stt API helps you do awesome stuff. 🚀
"""
...
app = FastAPI(
    ...
    terms_of_service="http://example_stt.com/terms/",
    contact={
        "name": "sivakorn-su",
        "url": "http://example_stt.com/contact/",
        "email": "sivakorn-su@example_stt.com",
    },
    license_info={
        "name": "The Unlicense",
