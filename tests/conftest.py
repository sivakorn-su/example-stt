...
# WARNING: Ensure imports from `example_stt` comes after this line
from example_stt import app, settings, db  # noqa
from example_stt.cli import create_user, cli  # noqa
